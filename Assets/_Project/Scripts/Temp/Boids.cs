...
public class Boids : MonoBehaviour, IChunkEntity
{
    ...
    private Tuple<List<Boids>[], AggregatedBoidChunk> NeighborInfo;

    private Boids NearestNeighbor;
    private int BoidId;
    ...
    /// <returns></returns>
    public void EvaluateNearestNeighbor(List<Boids>[] neighborsLists)
    {
        var count = 1;
    ...
    {
        ChunkManager = (IChunkManager<Boids, AggregatedBoidChunk>)manager;
    }
