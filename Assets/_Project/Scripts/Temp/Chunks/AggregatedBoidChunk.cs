...
public class AggregatedBoidChunk : IChunkAggregation<AggregatedBoidChunk, Boids>
{
    ...
    /// <returns></returns>
    public AggregatedBoidChunk Include(Boids entity)
    {
        Count++;
